...
clearTimeout(c);c=setTimeout(j,500)}).bind("mouseup."+g,function(a){d.publish(g+".windowmouseup",a)});var i={exampleExtension:function(a){this.events.subscribe(e+".initializing",function(){this.settings.hasOwnProperty("non-existent setting category?")&&console.log(a+" is here")})}},n={"default":function(){return this.toDataURL()},"native":function(a){return a},image:function(){var a=this.toDataURL();if("string"===typeof a&&4<a.length&&"data:"===a.slice(0,5)&&-1!==a.indexOf(",")){var b=a.indexOf(",");
return[a.slice(5,b),a.substr(b+1)]}return[]}},w={"native":function(a,b,c){c(a)},image:k,"image/png;base64":k,"image/jpeg;base64":k,"image/jpg;base64":k},l={"export":n,"import":w,instance:i},A={init:function(a){return this.each(function(){console.log("Initing jSignature");var b,c=!1;for(b=this.parentNode;b&&!c;)c=b.body,b=b.parentNode;!c||new p(this,a,i)})},getSettings:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+".this").settings},clear:q,reset:q,addPlugin:function(a,
b,c){l.hasOwnProperty(a)&&(l[a][b]=c);return this},listPlugins:function(a){var b=[];if(l.hasOwnProperty(a)){var a=l[a],c;for(c in a)a.hasOwnProperty(c)&&b.push(c)}return b},getData:function(a){var b=this.find("canvas."+e).add(this.filter("canvas."+e));void 0===a&&(a="default");if(0!==b.length&&n.hasOwnProperty(a))return n[a].call(b.get(0),b.data(e+".data"))},importData:b,setData:b,globalEvents:function(){return d},events:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+
".this").events}};$.fn[e]=function(a){if(!a||"object"===typeof a)return A.init.apply(this,arguments);if("string"===typeof a&&A[a])return A[a].apply(this,Array.prototype.slice.call(arguments,1));$.error("Method "+String(a)+" does not exist on jQuery."+e)}})();
