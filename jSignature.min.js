...
p.bind("mousemove.jSignature",z)}):(h.ontouchstart=function(b){h.onmousedown=null;E=-15>-5*a.lineWidth?-5*a.lineWidth:-15;y();h.ontouchstart=s;h.ontouchend=r;h.ontouchmove=z;s(b)},h.onmousedown=function(a){h.ontouchstart=null;y();h.onmousedown=s;h.onmouseup=r;h.onmousemove=z;s(a)});p.data("jSignature.reset",c);o(document).bind("mouseup.jSignature",r);c(a.data)},l={"default":function(){return this.toDataURL()},"native":function(b){return b},image:function(){var b=this.toDataURL();if("string"===typeof b&&
4<b.length&&"data:"===b.slice(0,5)&&-1!==b.indexOf(",")){var a=b.indexOf(",");return[b.slice(5,a),b.substr(a+1)]}return[]}},e={"default":function(b,a,c){c(b)}},c={init:function(b){return this.each(function(){m.call(this,b)})},reset:function(b){this.find("canvas.jSignature").add(this.filter("canvas.jSignature")).data("jSignature.reset")(b);return this},addPlugin:function(b,a,c){var j={"export":l,"import":e};j.hasOwnProperty(b)&&(j[b][a]=c);return this},listPlugins:function(b){var a={"export":l,"import":e},
c=[];if(a.hasOwnProperty(b)){var b=a[b],j;for(j in b)b.hasOwnProperty(j)&&c.push(j)}return c},getData:function(b){var a=this.find("canvas.jSignature").add(this.filter("canvas.jSignature"));void 0===b&&(b="default");if(0!==a.length&&l.hasOwnProperty(b))return l[b].call(a.get(0),a.data("jSignature.data"))},setData:function(b,a){var c=this.find("canvas.jSignature").add(this.filter("canvas.jSignature"));if(void 0===a&&"string"===typeof b&&(a=b.split(",")[0],a===b))return;0!==c.length&&e.hasOwnProperty(a)&&
