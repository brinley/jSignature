...
setTimeout(function(){d(c,b)},3);return a}return null};this.endStroke=function(){var a=this.inStroke;this.inStroke=!1;this._lastPoint=null;if(a){var b=this.endStrokeFn,c=this._stroke;setTimeout(function(){b(c)},3);return!0}return null}}var m=function(b){var a={width:"max",height:"max",sizeRatio:4,color:"#000","background-color":"#fff","decor-color":"#eee",lineWidth:0},c=p(this);p.extend(a,q(c));b&&p.extend(a,b);if("max"==a.width||"max"==a.height){var b=c.width(),j=c.height();b/a.sizeRatio>j&&(j=parseInt(b/
a.sizeRatio,10));a.width=b;a.height=j}if(0==a.lineWidth)b=parseInt(a.width,10),b=parseInt(b/300,10),a.lineWidth=2>b?2:b;var l=1E3>parseInt(a.width,10)?!0:!1,o=c.find("canvas"),h;o.length?h=o.get(0):(h=document.createElement("canvas"),h.width=a.width,h.height=a.height,o=p(h),o.appendTo(c));o.addClass("jSignature");var f=!1,e=1;h.getContext||("undefined"!==typeof FlashCanvas?(window&&window.screen&&window.screen.deviceXDPI&&window.screen.logicalXDPI&&(e=window.screen.deviceXDPI/window.screen.logicalXDPI),
h=FlashCanvas.initElement(h),1!=e&&o.children("object").get(0).resize(Math.ceil(h.width*e),Math.ceil(h.height*e)),f=!0):"undefined"!=typeof G_vmlCanvasManager&&(h=G_vmlCanvasManager.initElement(h),f=!0));if(!h.getContext)throw Error("Canvas element does not support 2d context. jSignature cannot proceed.");h.onselectstart=function(a){a&&a.preventDefault&&a.preventDefault();a&&a.stopPropagation&&a.stopPropagation();return!1};a.cssclass&&""!=p.trim(a.cssclass)&&o.addClass(a.cssclass);var k=h.getContext("2d"),
m,u,v,w,A,B,C=-1*Math.round(a.lineWidth/2),x=function(a,b,c,g){k.beginPath();k.moveTo(a,b);k.lineTo(c,g);k.stroke()},c=function(b){var c=h.width,g=h.height;k.clearRect(0,0,c*e+30,g*e+30);k.shadowColor=k.fillStyle=a["background-color"];f&&k.fillRect(0,0,c*e+30,g*e+30);k.lineWidth=Math.ceil(parseInt(a.lineWidth,10)*e);k.lineCap=k.lineJoin="round";var d=Math.round(g/5);k.strokeStyle=a["decor-color"];k.shadowOffsetX=0;k.shadowOffsetY=0;x(1.5*d,g-d,c-1.5*d,g-d);k.strokeStyle=a.color;if(!f&&!l)k.shadowColor=
k.strokeStyle,k.shadowOffsetX=0.5*k.lineWidth,k.shadowOffsetY=-0.6*k.lineWidth,k.shadowBlur=0;if(void 0===b)b=[];else for(var c=b.length,j=0;j<c;j++){g=b[j];d=g.x.length;u(g);for(var n=1;n<d;n++)v(g,n);w(g)}m=new i(b);m.startStrokeFn=u;m.addToStrokeFn=v;m.endStrokeFn=w;o.data("jSignature.data",b);return!0},t=null,r=function(a){try{a.preventDefault()}catch(b){}clearTimeout(t);m.endStroke()},D=0,E=function(a){a=a.changedTouches&&0<a.changedTouches.length?a.changedTouches[0]:a;return new n(Math.round((a.pageX+
A)*e),Math.round((a.pageY+B)*e)+D)},s=function(a){a.preventDefault();var b=o.offset();A=-1*b.left;B=-1*b.top;m.startStroke(E(a));clearTimeout(t);t=setTimeout(r,750)},y=function(a){a.preventDefault();m.inStroke&&m.addToStroke(E(a))&&(clearTimeout(t),t=setTimeout(r,750))},z=3*a.lineWidth;u=function(b){var c=b.x[0],b=b.y[0];k.fillStyle=a.color;k.fillRect(c+C,b+C,a.lineWidth,a.lineWidth);k.fillStyle=a["background-color"]};v=function(a,b){var c=new n(a.x[b-1],a.y[b-1]),g=new n(a.x[b],a.y[b]),h=c.getVectorToPoint(g);
if(1<b){var f=new n(a.x[b-2],a.y[b-2]),j=f.getVectorToPoint(c),e;if(j.getLength()>z){e=2<b?(new n(a.x[b-3],a.y[b-3])).getVectorToPoint(f):new d(0,0);var i=j.getLength()/2,l=(new d(e.x+j.x,e.y+j.y)).resizeTo(i),o=(new d(j.x+h.x,j.y+h.y)).reverse().resizeTo(i),j=f.x,i=f.y;e=c.x;var m=c.y,F=f.x+l.x,f=f.y+l.y,l=c.x+o.x,o=c.y+o.y;k.beginPath();k.moveTo(j,i);k.bezierCurveTo(F,f,l,o,e,m);k.stroke()}}h.getLength()<=z&&x(c.x,c.y,g.x,g.y)};w=function(a){var b=a.x.length-1;if(0<b){var c=new n(a.x[b],a.y[b]),
g=new n(a.x[b-1],a.y[b-1]),f=g.getVectorToPoint(c);if(f.getLength()>z)if(1<b){var a=(new n(a.x[b-2],a.y[b-2])).getVectorToPoint(g),j=(new d(a.x+f.x,a.y+f.y)).resizeTo(f.getLength()/2),f=g.x,a=g.y,b=c.x,h=c.y,e=g.x+j.x,g=g.y+j.y,j=c.x,c=c.y;k.beginPath();k.moveTo(f,a);k.bezierCurveTo(e,g,j,c,b,h);k.stroke()}else x(g.x,g.y,c.x,c.y)}};f?o.bind("mousedown.jSignature",function(a){o.unbind("mousedown.jSignature");s(a);o.bind("mousemove.jSignature",y);o.bind("mouseup.jSignature",r);o.bind("mousedown.jSignature",
s)}):(h.ontouchstart=function(b){h.onmousedown=null;D=-15>-5*a.lineWidth?-5*a.lineWidth:-15;s(b);h.ontouchend=r;h.ontouchstart=s;h.ontouchmove=y},h.onmousedown=function(a){h.ontouchstart=null;s(a);h.onmousedown=s;h.onmouseup=r;h.onmousemove=y});o.data("jSignature.reset",c);p(document).bind("mouseup.jSignature",r);c(a.data)},l={"default":function(){return this.toDataURL()},"native":function(b){return b},image:function(){var b=this.toDataURL();if("string"===typeof b&&4<b.length&&"data:"===b.slice(0,
5)&&-1!==b.indexOf(",")){var a=b.indexOf(",");return[b.slice(5,a),b.substr(a+1)]}return[]}},e={"native":function(b,a,c){c(b)}},c={init:function(b){return this.each(function(){m.call(this,b)})},reset:function(b){this.find("canvas.jSignature").add(this.filter("canvas.jSignature")).data("jSignature.reset")(b);return this},addPlugin:function(b,a,c){var j={"export":l,"import":e};j.hasOwnProperty(b)&&(j[b][a]=c);return this},listPlugins:function(b){var a={"export":l,"import":e},c=[];if(a.hasOwnProperty(b)){var b=
a[b],j;for(j in b)b.hasOwnProperty(j)&&c.push(j)}return c},getData:function(b){var a=this.find("canvas.jSignature").add(this.filter("canvas.jSignature"));void 0===b&&(b="default");if(0!==a.length&&l.hasOwnProperty(b))return l[b].call(a.get(0),a.data("jSignature.data"))},setData:function(b,a){var c=this.find("canvas.jSignature").add(this.filter("canvas.jSignature"));if(void 0===a&&"string"===typeof b&&(a=b.split(",")[0],a===b))return;0!==c.length&&e.hasOwnProperty(a)&&e[a].call(c.get(0),b,a,c.data("jSignature.reset"));
return this}};p.fn.jSignature=function(b){if(c[b])return c[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return c.init.apply(this,arguments);p.error("Method "+b+" does not exist on jQuery.jSignature")};return p})(this.jQuery)})("undefined"!==typeof window?window:this);/*
 ...
 MIT License <http://www.opensource.org/licenses/mit-license.php> 
*/
(function(){for(var p={},q={},d=29;-1<d;d--)p["0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX"[d]]="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX"[d+30],q["0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX"[d+30]]="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX"[d];var n=function(c){for(var c=c.split(""),b=c.length,a=1;a<b;a++)c[a]=p[c[a]];return c.join("")},i=function(c){for(var b=[],a=0,g=1,j=c.length,d,e,h=0;h<j;h++)d=c[h],e=d-a,a=d,0>e&&0<
g?(g=-1,b.push("Z")):0<e&&0>g&&(g=1,b.push("Y")),d=Math.abs(e),30<=d?b.push(n(d.toString(30))):b.push(d.toString(30));return b.join("")},m=function(c){for(var b=[],c=c.split(""),a=c.length,g,d=1,e=[],i=0,h=0;h<a;h++)g=c[h],g in p||"Z"===g||"Y"===g?(0!==e.length&&(e=parseInt(e.join(""),30)*d+i,b.push(e),i=e),"Z"===g?(d=-1,e=[]):"Y"===g?(d=1,e=[]):e=[g]):e.push(q[g]);b.push(parseInt(e.join(""),30)*d+i);return b},l=function(c){for(var b=[],a=c.length,d,e=0;e<a;e++)d=c[e],b.push(i(d.x)),b.push(i(d.y));
