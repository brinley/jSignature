...
jSignature v2 "2012-10-10T18:08" "commit ID d359a43866382f4845944f53b630774b8eefa7a7"
...
*/
(function(){function s(a){for(var f,p=a.css("color"),y,a=a[0],c=!1;a&&!y&&!c;){try{f=$(a).css("background-color")}catch(g){f="transparent"}"transparent"!==f&&"rgba(0, 0, 0, 0)"!==f&&(y=f);c=a.body;a=a.parentNode}var a=/rgb[a]*\((\d+),\s*(\d+),\s*(\d+)/,c=/#([AaBbCcDdEeFf\d]{2})([AaBbCcDdEeFf\d]{2})([AaBbCcDdEeFf\d]{2})/,b;f=void 0;(f=p.match(a))?b={r:parseInt(f[1],10),g:parseInt(f[2],10),b:parseInt(f[3],10)}:(f=p.match(c))&&(b={r:parseInt(f[1],16),g:parseInt(f[2],16),b:parseInt(f[3],16)});var d;y?
(f=void 0,(f=y.match(a))?d={r:parseInt(f[1],10),g:parseInt(f[2],10),b:parseInt(f[3],10)}:(f=y.match(c))&&(d={r:parseInt(f[1],16),g:parseInt(f[2],16),b:parseInt(f[3],16)})):d=b?127<Math.max.apply(null,[b.r,b.g,b.b])?{r:0,g:0,b:0}:{r:255,g:255,b:255}:{r:255,g:255,b:255};f=function(a){return"rgb("+[a.r,a.g,a.b].join(", ")+")"};b&&d?(a=Math.max.apply(null,[b.r,b.g,b.b]),b=Math.max.apply(null,[d.r,d.g,d.b]),b=Math.round(b+-0.75*(b-a)),b={r:b,g:b,b:b}):b?(b=Math.max.apply(null,[b.r,b.g,b.b]),a=1,127<b&&
(a=-1),b=Math.round(b+96*a),b={r:b,g:b,b:b}):b={r:191,g:191,b:191};return{color:p,"background-color":d?f(d):y,"decor-color":f(b)}}function m(a,f){this.x=a;this.y=f;this.reverse=function(){return new this.constructor(-1*this.x,-1*this.y)};this._length=null;this.getLength=function(){this._length||(this._length=Math.sqrt(Math.pow(this.x,2)+Math.pow(this.y,2)));return this._length};var p=function(a){return Math.round(a/Math.abs(a))};this.resizeTo=function(a){if(0===this.x&&0===this.y)this._length=0;else if(0===
this.x)this._length=a,this.y=a*p(this.y);else if(0===this.y)this._length=a,this.x=a*p(this.x);else{var f=Math.abs(this.y/this.x),b=Math.sqrt(Math.pow(a,2)/(1+Math.pow(f,2))),f=f*b;this._length=a;this.x=b*p(this.x);this.y=f*p(this.y)}return this};this.angleTo=function(a){var f=this.getLength()*a.getLength();return 0===f?0:Math.acos(Math.min(Math.max((this.x*a.x+this.y*a.y)/f,-1),1))/Math.PI}}function h(a,f){this.x=a;this.y=f;this.getVectorToCoordinates=function(a,f){return new m(a-this.x,f-this.y)};
...
this.fatFingerCompensation=0;var c=function(a){var f,b,c=function(c){c=c.changedTouches&&0<c.changedTouches.length?c.changedTouches[0]:c;return new h(Math.round(c.pageX+f),Math.round(c.pageY+b)+a.fatFingerCompensation)},p=new z(750,function(){a.dataEngine.endStroke()});this.drawEndHandler=function(f){try{f.preventDefault()}catch(b){}p.clear();a.dataEngine.endStroke()};this.drawStartHandler=function(d){d.preventDefault();var g=$(a.canvas).offset();f=-1*g.left;b=-1*g.top;a.dataEngine.startStroke(c(d));
...
-3*d.lineWidth:d.minFatFingerCompensation;k(a);n.ontouchend=i;n.ontouchstart=k;n.ontouchmove=l},n.onmousedown=function(a){n.ontouchstart=void 0;n.ontouchend=void 0;n.ontouchmove=void 0;k(a);n.onmousedown=k;n.onmouseup=i;n.onmousemove=l});a[e+".windowmouseup"]=g.subscribe(e+".windowmouseup",c.drawEndHandler);this.events.publish(e+".attachingEventHandlers");var r=this,a=d.width.toString(10),x=e;if("ratio"===a||"%"===a.split("")[a.length-1])this.eventTokens[x+".parentresized"]=g.subscribe(x+".parentresized",
function(a,f,b){return function(){var c=f.width();if(c!==b){for(var p in a)a.hasOwnProperty(p)&&(g.unsubscribe(a[p]),delete a[p]);var d=r.settings;r.$parent.children().remove();for(p in r)r.hasOwnProperty(p)&&delete r[p];p=d.data;var c=1*c/b,y=[],j,i,e,k,h,n;i=0;for(e=p.length;i<e;i++){n=p[i];j={x:[],y:[]};k=0;for(h=n.x.length;k<h;k++)j.x.push(n.x[k]*c),j.y.push(n.y[k]*c);y.push(j)}d.data=y;f[x](d)}}}(this.eventTokens,this.$parent,this.$parent.width(),1*this.canvas.width/this.canvas.height));this.resetCanvas(d.data);
this.events.publish(e+".initialized");return this}var e="jSignature",z=function(a,f){var b;this.kick=function(){clearTimeout(b);b=setTimeout(f,a)};this.clear=function(){clearTimeout(b)};return this},u=function(a){this.topics={};this.context=a?a:this;this.publish=function(a,b,c,d){if(this.topics[a]){var g=this.topics[a],j=Array.prototype.slice.call(arguments,1),i=[],k,e,h,n;e=0;for(h=g.length;e<h;e++)n=g[e],k=n[0],n[1]&&(n[0]=function(){},i.push(e)),k.apply(this.context,j);e=0;for(h=i.length;e<h;e++)g.splice(i[e],
1)}};this.subscribe=function(a,b,c){this.topics[a]?this.topics[a].push([b,c]):this.topics[a]=[[b,c]];return{topic:a,callback:b}};this.unsubscribe=function(a){if(this.topics[a.topic])for(var b=this.topics[a.topic],c=0,d=b.length;c<d;c++)b[c][0]===a.callback&&b.splice(c,1)}},A=function(a){var f=this.canvasContext,b=a.x[0],a=a.y[0],c=this.settings.lineWidth,d=f.fillStyle;f.fillStyle=f.strokeStyle;f.fillRect(b+c/-2,a+c/-2,c,c);f.fillStyle=d},v=function(a,f){var b=new h(a.x[f-1],a.y[f-1]),c=new h(a.x[f],
a.y[f]),d=b.getVectorToPoint(c);if(1<f){var g=new h(a.x[f-2],a.y[f-2]),j=g.getVectorToPoint(b),i;if(j.getLength()>this.lineCurveThreshold){i=2<f?(new h(a.x[f-3],a.y[f-3])).getVectorToPoint(g):new m(0,0);var e=0.35*j.getLength(),k=j.angleTo(i.reverse()),n=d.angleTo(j.reverse());i=(new m(i.x+j.x,i.y+j.y)).resizeTo(Math.max(0.05,k)*e);var l=(new m(j.x+d.x,j.y+d.y)).reverse().resizeTo(Math.max(0.05,n)*e),j=this.canvasContext,e=g.x,n=g.y,k=b.x,r=b.y,x=g.x+i.x,g=g.y+i.y;i=b.x+l.x;l=b.y+l.y;j.beginPath();
j.moveTo(e,n);j.bezierCurveTo(x,g,i,l,k,r);j.stroke()}}d.getLength()<=this.lineCurveThreshold&&(d=this.canvasContext,g=b.x,b=b.y,i=c.x,c=c.y,d.beginPath(),d.moveTo(g,b),d.lineTo(i,c),d.stroke())},w=function(a){var b=a.x.length-1;if(0<b){var c=new h(a.x[b],a.y[b]),d=new h(a.x[b-1],a.y[b-1]),g=d.getVectorToPoint(c);if(g.getLength()>this.lineCurveThreshold){if(1<b){var a=(new h(a.x[b-2],a.y[b-2])).getVectorToPoint(d),j=(new m(a.x+g.x,a.y+g.y)).resizeTo(g.getLength()/2),g=this.canvasContext,a=d.x,b=d.y,
...
d.lineJoin="round";d.strokeStyle=c["decor-color"];d.shadowOffsetX=0;d.shadowOffsetY=0;var k=Math.round(i/5),n=1.5*k,h=i-k,j=j-1.5*k,i=i-k;d.beginPath();d.moveTo(n,h);d.lineTo(j,i);d.stroke();d.strokeStyle=c.color;g||(d.shadowColor=d.strokeStyle,d.shadowOffsetX=0.5*d.lineWidth,d.shadowOffsetY=-0.6*d.lineWidth,d.shadowBlur=0);a||(a=[]);d=this.dataEngine=new t(a,this,A,v,w);c.data=a;$(b).data(e+".data",a).data(e+".settings",c);var l=this.$parent,r=this.events,x=e;d.changed=function(){r.publish(x+".change");
...
this.isCanvasEmulator=a;b.onselectstart=function(a){a&&a.preventDefault&&a.preventDefault();a&&a.stopPropagation&&a.stopPropagation();return!1};return b};var k=function(a,c){var b=new Image,d=this;b.onload=function(){d.getContext("2d").drawImage(b,0,0,b.width<d.width?b.width:d.width,b.height<d.height?b.height:d.height)};b.src="data:"+c+","+a},r=function(a){this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+".this").resetCanvas(a);return this},b=function(a,b){if(void 0===b&&("string"===typeof a&&
"data:"===a.substr(0,5))&&(b=a.slice(5).split(",")[0],a=a.slice(6+b.length),b===a))return;var c=this.find("canvas."+e).add(this.filter("canvas."+e));if(x.hasOwnProperty(b))0!==c.length&&x[b].call(c[0],a,b,function(a){return function(){return a.resetCanvas.apply(a,arguments)}}(c.data(e+".this")));else throw Error(e+" is unable to find import plugin with for format '"+String(b)+"'");return this},d=new u,g=e,c,j=function(){d.publish(g+".parentresized")};$(window).bind("resize."+g,function(){c&&clearTimeout(c);
c=setTimeout(j,500)}).bind("mouseup."+g,function(a){d.publish(g+".windowmouseup",a)});var i={},n={"default":function(){return this.toDataURL()},"native":function(a){return a},image:function(){var a=this.toDataURL();if("string"===typeof a&&4<a.length&&"data:"===a.slice(0,5)&&-1!==a.indexOf(",")){var b=a.indexOf(",");return[a.slice(5,b),a.substr(b+1)]}return[]}},x={"native":function(a,b,c){c(a)},image:k,"image/png;base64":k,"image/jpeg;base64":k,"image/jpg;base64":k},l={"export":n,"import":x,instance:i},
B={init:function(a){return this.each(function(){var b,c=!1;for(b=this.parentNode;b&&!c;)c=b.body,b=b.parentNode;!c||new q(this,a,i)})},getSettings:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+".this").settings},clear:r,reset:r,addPlugin:function(a,b,c){l.hasOwnProperty(a)&&(l[a][b]=c);return this},listPlugins:function(a){var b=[];if(l.hasOwnProperty(a)){var a=l[a],c;for(c in a)a.hasOwnProperty(c)&&b.push(c)}return b},getData:function(a){var b=this.find("canvas."+e).add(this.filter("canvas."+
e));void 0===a&&(a="default");if(0!==b.length&&n.hasOwnProperty(a))return n[a].call(b.get(0),b.data(e+".data"))},importData:b,setData:b,globalEvents:function(){return d},events:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+".this").events}};$.fn[e]=function(a){if(!a||"object"===typeof a)return B.init.apply(this,arguments);if("string"===typeof a&&B[a])return B[a].apply(this,Array.prototype.slice.call(arguments,1));$.error("Method "+String(a)+" does not exist on jQuery."+
e)}})();
...
(function(){for(var s={},m={},h="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWX".split(""),t=h.length/2,q=t-1;-1<q;q--)s[h[q]]=h[q+t],m[h[q+t]]=h[q];var e=function(e){for(var e=e.split(""),h=e.length,b=1;b<h;b++)e[b]=s[e[b]];return e.join("")},z=function(h){for(var r=[],b=0,d=1,g=h.length,c,j,i=0;i<g;i++)c=Math.round(h[i]),j=c-b,b=c,0>j&&0<d?(d=-1,r.push("Z")):0<j&&0>d&&(d=1,r.push("Y")),c=Math.abs(j),c>=t?r.push(e(c.toString(t))):r.push(c.toString(t));return r.join("")},u=function(e){for(var h=
[],e=e.split(""),b=e.length,d,g=1,c=[],j=0,i=0;i<b;i++)d=e[i],d in s||"Z"===d||"Y"===d?(0!==c.length&&(c=parseInt(c.join(""),t)*g+j,h.push(c),j=c),"Z"===d?(g=-1,c=[]):"Y"===d?(g=1,c=[]):c=[d]):c.push(m[d]);h.push(parseInt(c.join(""),t)*g+j);return h},A=function(e){for(var h=[],b=e.length,d,g=0;g<b;g++)d=e[g],h.push(z(d.x)),h.push(z(d.y));return h.join("_")},v=function(e){for(var h=[],e=e.split("_"),b=e.length/2,d=0;d<b;d++)h.push({x:u(e[2*d]),y:u(e[2*d+1])});return h},h=function(e){return["image/jsignature;base30",
A(e)]},q=function(e,h,b){"string"===typeof e&&("image/jsignature;base30"===e.substring(0,23).toLowerCase()&&(e=e.substring(24)),b(v(e)))};if(null==this.jQuery)throw Error("We need jQuery for some of the functionality. jQuery is not detected. Failing to initialize...");var w=this.jQuery.fn.jSignature;w("addPlugin","export","base30",h);w("addPlugin","export","image/jsignature;base30",h);w("addPlugin","import","base30",q);w("addPlugin","import","image/jsignature;base30",q);this.jSignatureDebug&&(this.jSignatureDebug.base30=
...
c;g++)j=m[g],d.push('<path fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="'+e(j,k,l)+'"/>');d.push("</svg>");return d.join("")}function u(b){return[k,z(b)]}function A(b){return[r,w(z(b))]}var v=window;"use strict";("undefined"!=typeof exports?exports:v).simplify=function(b,d,e){d=void 0!==d?d*d:1;if(!e){for(var c=b.length,j,i=b[0],h=[i],e=1;e<c;e++){j=b[e];var k=j.x-i.x,l=j.y-i.y;k*k+l*l>d&&(h.push(j),i=j)}b=(i!==j&&h.push(j),h)}j=b;var e=j.length,
